/*
    Highest Number Function (Part 2) - 2
        Write a function that takes in an array of numbers and returns the one number that is the highest number in that array. 
        
        Ex: passing [3,4,6,10,1,300,9] returns 300;
    ...
    Unique Elements Function - 3
        Write a function that takes an array of numbers as an argument and returns a new array containing only the unique elements from the original array (no duplicates).

        Ex: passing in [300,300,400,400] should return [300,400]
